...
--6- Ejecute el procedimiento almacenado "pa_empleados_sueldo" sin parámetros.Mensaje de error.
...
--10- Ejecute el procedimiento "pa_empleados_actualizar_sueldo" enviando un solo parámetro.Error.
 exec pa_empleados_actualizar_sueldo 300,350;
 select * from empleados;
 
-- exec pa_empleados_actualizar_sueldo 350;

--11- Ejecute el procedimiento almacenado "pa_empleados_actualizar_sueldo" enviando en primer lugar el parámetro @sueldonuevo y en segundo lugar @sueldoanterior (parámetros por nombre).
