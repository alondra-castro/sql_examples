...
--7- Intente agregar un registro que infrinja la restricción.No lo permite.


 insert into clientes values(150,'Karina Gomez','Caseros 444','Cruz del Eje',8);

--8- Intente modificar el código de un cliente que está referenciado en "referenciadopor".No se puede.
